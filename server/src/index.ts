...
import { generateTasks, getTasks, updateTasks, debugTasksLLM } from './tasks/handlers.js'
...
app.get('/api/projects/:id/generate-tasks/debug', authMiddleware, debugTasksLLM) // DEBUG
